...
[![Build Status](https://travis-ci.org/007arunwilson/open-api-repo.svg?branch=master)](https://travis-ci.org/007arunwilson/open-api-repo)
...
6. If you did everything correct, https://007arunwilson.github.io/open-api-repo/ will lead to your new docs
...
- Documentation(ReDoc): https://007arunwilson.github.io/open-api-repo/
- SwaggerUI: https://007arunwilson.github.io/open-api-repo/swagger-ui/
- Look full spec:
    + JSON https://007arunwilson.github.io/open-api-repo/swagger.json
    + YAML https://007arunwilson.github.io/open-api-repo/swagger.yaml
- Preview spec version for branch `[branch]`: https://007arunwilson.github.io/open-api-repo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://007arunwilson.github.io/open-api-repo/ with url from the message: `Server started <url>`
